...
4. Clone this repository <a href="https://github.com/cbroberg/node-mvc-api" target="_blank">node-mvc-api</a> from Github, and run ```npm install```, open node-mvc-api in your text editor of choice (did anyone mention Atom), and run ```npm start``` from the terminal
